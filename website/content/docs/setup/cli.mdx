...
<iframe width="100%" src="https://www.youtube.com/embed/czLC-N9ZRnY?si=VnnpwZ9rSM24ecAK&amp;start=37&amp;end=116" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen style={{aspectRatio: '16/9'}}></iframe>

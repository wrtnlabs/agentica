...
Do not build a complicated agent graph or workflow first. List **Swagger/OpenAPI/MCP** documents or **TypeScript class** types to `@agentica`, then `@agentica` handles the function calling loop.

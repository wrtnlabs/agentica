...
export async function callee<Model extends ILlmSchema.Model>(
...
async function correctTypeError<Model extends ILlmSchema.Model>(
  ...
  // // Failed too much a lot
  // const giveUp = () => createExecuteEvent({
  //   operation: callEvent.operation,
  //   arguments: callEvent.arguments,
  //   value: {
  //     name: "ValidationError",
  ...
  //     {
  //       role: "system",
  //       content: ctx.config?.systemPrompt?.validate?.(previousValidationErrors.slice(0, -1))
  //         ?? [
  //           AgenticaSystemPrompt.VALIDATE,
  //           ...(previousValidationErrors.length > 1
  //             ? [
  ...
  //       function: {
  //         name: callEvent.operation.name,
  //         description: callEvent.operation.function.description,
  //         /**
  //          * @TODO fix it
  //          * The property and value have a type mismatch, but it works.
  //          */
  //         parameters: (
  //           ("separated" in callEvent.operation.function
  //             && callEvent.operation.function.separated !== undefined)
  //             ? (callEvent.operation.function.separated?.llm
  //               ?? ({
  //                 $defs: {},
  //                 type: "object",
  //                 properties: {},
  ...
  //             : callEvent.operation.function.parameters) as unknown as Record<string, unknown>,
  //       },
  //     },
  //   ],
  //   tool_choice: {
  ...
  //   s => s.function.name === callEvent.operation.name,
  // );
...
async function correctJsonError<Model extends ILlmSchema.Model>(
  ...
  //           id: v4(),
  //           function: {
  //             name: parseErrorEvent.operation.name,
  //             arguments: JSON.stringify(parseErrorEvent.arguments),
  //           },
  //         } satisfies OpenAI.ChatCompletionMessageToolCall,
  //       ],
  //     } satisfies OpenAI.ChatCompletionAssistantMessageParam,
  //     {
  //       role: "tool",
  //       content: parseErrorEvent.arguments,
  //       tool_call_id: parseErrorEvent.id,
  //     } satisfies OpenAI.ChatCompletionToolMessageParam,
  //     {
  //       role: "system",
  //       content: ctx.config?.systemPrompt?.jsonParseError?.(parseErrorEvent)
  //         ?? AgenticaSystemPrompt.JSON_PARSE_ERROR.replace(
  //           "${{ERROR_MESSAGE}}",
  //           parseErrorEvent.errorMessage,
  //         ),
  ...
  //       function: {
  //         name: parseErrorEvent.operation.name,
  //         description: parseErrorEvent.operation.function.description,
  //         /**
  //          * @TODO fix it
  //          * The property and value have a type mismatch, but it works.
  //          */
  //         parameters: (
  //           ("separated" in parseErrorEvent.operation.function
  //             && parseErrorEvent.operation.function.separated !== undefined)
  //             ? (parseErrorEvent.operation.function.separated?.llm
  //               ?? ({
  //                 $defs: {},
  //                 type: "object",
  //                 properties: {},
  ...
  //             : parseErrorEvent.operation.function.parameters) as unknown as Record<string, unknown>,
  //       },
  //     },
  //   ],
  //   tool_choice: {
  ...
  // const toolCall: OpenAI.ChatCompletionMessageToolCall | undefined = completion.choices[0]?.message.tool_calls?.find(
  //   s => s.function.name === parseErrorEvent.operation.name,
  // );
  // return toolCall === undefined
  //   ? giveUp()
  //   : predicate(
  //       ctx,
  //       parseErrorEvent.operation,
  //       toolCall,
  //       previousValidationErrors,
  //       life,
  //     );

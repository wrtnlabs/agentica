...
- Reason: User wants detailed information about the Macbook.
...
- Reason: User wants to take the shopping cart to the order.
...
- Reason: User wants to publish the order with cash payment and provided address.

...
- Reason: The user wants to see every sales in the shopping mall, so I need to list up every summarized sales.
...
- Reason: The user wants detailed information about the Macbook, I need to get the sale ID for Macbook after listing the sales.
...
- Reason: After getting the stocks, I will pick the most expensive stock from the Macbook and add it to the shopping cart.
...
- Reason: Once the item is added to the cart, I will create an order application from the shopping cart.
...
- Reason: The user wants to publish the order by cash payment, so I need to publish the order once it is created.

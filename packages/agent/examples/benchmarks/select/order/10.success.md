...
### shoppings_customers_sales_at
  ...
  - Reason: The user requests for detailed information about a specific sale, in this case, the Macbook.
...
### shoppings_customers_carts_commodities_create
  ...
  - Reason: The user wants to create a shopping cart commodity from the selected stock of the Macbook.
...
### shoppings_customers_orders_create
  ...
  - Reason: Finally, the user wants to create an order application from the shopping cart.

...
### shoppings_customers_sales_index
  ...
  - Reason: To retrieve a list of every summarized sales available in the shopping mall.
...
### shoppings_customers_sales_at
  ...
  - Reason: To get detailed information about the Macbook sale after identifying it from the list of sales.
...
### shoppings_customers_carts_commodities_create
  ...
  - Reason: To select the most expensive stock from the Macbook and add it to the shopping cart.
...
### shoppings_customers_orders_create
  ...
  - Reason: To create a new order application from the shopping cart after adding the Macbook stock.

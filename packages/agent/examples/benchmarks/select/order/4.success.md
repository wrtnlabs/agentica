...
### shoppings_customers_sales_index
  ...
  - Reason: To list every available sales in the shopping mall.
...
### shoppings_customers_sales_at
  ...
  - Reason: To retrieve detailed information on the specified sale, in this case, the Macbook.
...
### shoppings_customers_carts_commodities_create
  ...
  - Reason: To create a new shopping cart commodity with the selected costly stock for the user to purchase.
...
### shoppings_customers_orders_create
  ...
  - Reason: To create a new order application from the shopping cart that has been composed by the customer.

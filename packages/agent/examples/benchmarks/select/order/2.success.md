...
### shoppings_customers_sales_index
  ...
  - Reason: To get the summary of every sales in the shopping mall.
...
### shoppings_customers_carts_commodities_create
  ...
  - Reason: To create a new commodity in the shopping cart from the selected stock of Macbook after getting information about it.
...
### shoppings_customers_orders_create
  ...
  - Reason: To create a new order application from the shopping cart after adding the commodity.

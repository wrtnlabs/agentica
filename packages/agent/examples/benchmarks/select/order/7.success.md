...
### shoppings_customers_sales_index
  ...
  - Reason: To retrieve a list of every summarized sale in the shopping mall.
...
### shoppings_customers_sales_at
  ...
  - Reason: To get detailed information about the specific sale for the Macbook, as we need more details after listing all sales.
...
### shoppings_customers_carts_commodities_create
  ...
  - Reason: To create a new shopping cart commodity from the selected Macbook stock.
...
### shoppings_customers_orders_create
  ...
  - Reason: To create a new order application from the shopping cart that has the commodity added.

...
import { IWrtnAgentExecutor } from "./IWrtnAgentExecutor";
...
export interface IWrtnAgentConfig {
   ...
   * running by the {@link WrtnAgent.conversate} function.
   *
   ...
   */
  executor?:
    | Partial<IWrtnAgentExecutor>
    | ((ctx: IWrtnAgentContext) => Promise<IWrtnAgentPrompt[]>);
}

...
### shoppings_customers_sales_index
  ...
  - Reason: The user wants to see all sales in the shopping mall.
...
### shoppings_customers_sales_at
  ...
  - Reason: Get detailed information about the Macbook sale after retrieving the sales.
...
### shoppings_customers_carts_commodities_create
  ...
  - Reason: Add the most expensive Macbook stock to the shopping cart for purchasing.
...
### shoppings_customers_orders_create
  ...
  - Reason: Create a new order application from the shopping cart that contains the selected Macbook.
...
### shoppings_customers_orders_publish_create
  ...
  - Reason: Publish the order with cash payment and provided delivery address.

...
### shoppings_customers_sales_index
  ...
  - Reason: To retrieve all sales in the shopping mall.
...
### shoppings_customers_sales_at
  ...
  - Reason: To get detailed information about the Macbook sale after fetching the sales.
...
### shoppings_customers_carts_commodities_create
  ...
  - Reason: To create a new shopping cart commodity based on the most expensive stock from Macbook sale.
...
### shoppings_customers_orders_create
  ...
  - Reason: To create a new order application from the shopping cart that includes the Macbook commodity.
...
### shoppings_customers_orders_publish_create
  ...
  - Reason: To publish the order with cash payment information including the delivery address.

...
### shoppings_customers_sales_index
  ...
  - Reason: To get the list of every sales available in the shopping mall.
...
### shoppings_customers_carts_commodities_create
  ...
  - Reason: To create a cart commodity for the selected Macbook stock.
...
### shoppings_customers_orders_create
  ...
  - Reason: To create a new order application from the shopping cart with the selected Macbook commodity.
...
### shoppings_customers_orders_publish_create
  ...
  - Reason: To publish the order with cash payment and specified address.
